...
namespace AgenciaViagemUp.Controllers
{
    public class ClienteController : Controller
    {
        ...
        public async Task<IActionResult> Create([Bind("Id,Nome,Idade")] ClienteModel clienteModel)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public async Task<IActionResult> Edit(int id, [Bind("Id,Nome,Idade")] ClienteModel clienteModel)
        {
